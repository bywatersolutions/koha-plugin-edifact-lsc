package Koha::Plugin::Com::ByWaterSolutions::EdifactLSC;
...
our $metadata = {
    name            => 'Edifact - LSC',
    author          => 'Kyle M Hall',
    description     => 'Edifact plugin for LSC',
...
sub edifact {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactLSC::Edifact;

    my $edifact = Koha::Plugin::Com::ByWaterSolutions::EdifactLSC::Edifact->new($args);
    return $edifact;
}
...
sub edifact_order {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactLSC::Edifact::Order;

    $args->{params}->{plugin} = $self;
    my $edifact_order = Koha::Plugin::Com::ByWaterSolutions::EdifactLSC::Edifact::Order->new( $args->{params} );
...
sub edifact_transport {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactLSC::Edifact::Transport;

    $args->{params}->{plugin} = $self;

    my $edifact_transport = Koha::Plugin::Com::ByWaterSolutions::EdifactLSC::Edifact::Transport->new( $args->{vendor_edi_account_id}, $self );
